...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("highcharts"), require("highcharts")["Point"], require("highcharts")["Axis"], require("highcharts")["Color"], require("highcharts")["SeriesRegistry"], require("highcharts")["RendererRegistry"], require("highcharts")["SVGRenderer"], require("highcharts")["SVGElement"], require("highcharts")["Templating"], require("highcharts")["Chart"], require("highcharts")["Series"]["types"]["column"], require("highcharts")["Series"], require("highcharts")["StackItem"]);
	else if(typeof define === 'function' && define.amd)
		define("highcharts/modules/stock", [["highcharts/highcharts"], ["highcharts/highcharts","Point"], ["highcharts/highcharts","Axis"], ["highcharts/highcharts","Color"], ["highcharts/highcharts","SeriesRegistry"], ["highcharts/highcharts","RendererRegistry"], ["highcharts/highcharts","SVGRenderer"], ["highcharts/highcharts","SVGElement"], ["highcharts/highcharts","Templating"], ["highcharts/highcharts","Chart"], ["highcharts/highcharts","Series","types","column"], ["highcharts/highcharts","Series"], ["highcharts/highcharts","StackItem"]], factory);
	else if(typeof exports === 'object')
		exports["highcharts/modules/stock"] = factory(require("highcharts"), require("highcharts")["Point"], require("highcharts")["Axis"], require("highcharts")["Color"], require("highcharts")["SeriesRegistry"], require("highcharts")["RendererRegistry"], require("highcharts")["SVGRenderer"], require("highcharts")["SVGElement"], require("highcharts")["Templating"], require("highcharts")["Chart"], require("highcharts")["Series"]["types"]["column"], require("highcharts")["Series"], require("highcharts")["StackItem"]);
	else
...
(function (StockChart) {
    ...
    function onAxisGetPlotLinePath(e) {
        var axis = this,
            ...
            result = [],
            _a = e.acrossPanes,
            acrossPanes = _a === void 0 ? true : _a,
            force = e.force,
            translatedValue = e.translatedValue,
            value = e.value,
            allPerpendicularAxes = (axis.isXAxis ? chart.yAxis : chart.xAxis) || [], 
            /**
