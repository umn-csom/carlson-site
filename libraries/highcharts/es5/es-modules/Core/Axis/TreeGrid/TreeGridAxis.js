...
var addEvent = U.addEvent, isArray = U.isArray, splat = U.splat, find = U.find, fireEvent = U.fireEvent, isObject = U.isObject, isString = U.isString, merge = U.merge, removeEvent = U.removeEvent, wrap = U.wrap;
/* *
 *
 *  Variables
 *
            ...
            axis.series.forEach(function (series, index) {
                var axisData = (series.options.data || []).map(function (d) {
                    ...
                    if (seriesHasPrimitivePoints_1[index] ||
                        (isArray(d) && ((_a = series.options.keys) === null || _a === void 0 ? void 0 : _a.length))) {
