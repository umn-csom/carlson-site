...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("highcharts/indicators/trix", [["highcharts/highcharts"], ["highcharts/highcharts","SeriesRegistry"]], factory);
	else if(typeof exports === 'object')
		exports["highcharts/indicators/trix"] = factory(require("highcharts"), require("highcharts")["SeriesRegistry"]);
	else
...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ trix_src; }
});
...
var TEMAIndicator = (highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()).seriesTypes.tema;

var correctFloat = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()).correctFloat, merge = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()).merge;
/* *
 *
 *  Class
 *
...
;// ./code/es5/es-modules/masters/indicators/trix.src.js




/* harmony default export */ var trix_src = ((highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()));
