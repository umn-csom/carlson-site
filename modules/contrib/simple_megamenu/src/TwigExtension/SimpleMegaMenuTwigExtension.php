 ...
 */
class SimpleMegaMenuTwigExtension extends AbstractExtension {
  ...
  public function getFunctions() {
    return [
      new TwigFunction('view_megamenu', [$this, 'viewMegaMenu']),
      new TwigFunction('has_megamenu', [$this, 'hasMegaMenu']),
    ];
  }
