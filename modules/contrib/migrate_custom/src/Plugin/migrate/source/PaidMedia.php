...
/**
 * @file
 * Contains \Drupal\migrate_custom\Plugin\migrate\source\PaidMedia.
 */
...
/**
 * Extract paid media from Drupal 7 database.
 *
 * @MigrateSource(
 *   id = "custom_pm"
 * )
 */
class PaidMedia extends SqlBase {
  ...
  public function query() {
    ...
    // Condition.
    $query->condition('f.type', 'paid_media');
    return $query;
  }
