...
/**
 * @file
 * Contains \Drupal\migrate_custom\Plugin\migrate\source\Organization.
 */
...
/**
 * Extract organization from Drupal 7 database.
 *
 * @MigrateSource(
 *   id = "custom_org"
 * )
 */
class Organization extends SqlBase {
  ...
  public function query() {
    ...
    // Condition.
    $query->condition('f.type', 'organization');
    return $query;
  }
