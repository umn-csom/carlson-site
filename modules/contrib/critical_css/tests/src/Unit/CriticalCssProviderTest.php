...
class CriticalCssProviderTest extends UnitTestCase {
  ...
  protected function setUp(): void {
    ...
    $optimizer = $this->createConfiguredMock(CssOptimizer::class, ['optimize' => FALSE]);

    $this->criticalCssProvider = new CriticalCssProvider($module_handler, $request_stack, $config_factory, $current_route_match, $current_path_stack, $current_user, $theme_manager, $admin_context, $optimizer);
  }
