...
//    $node_type->setThirdPartySetting('social_simple', 'share', 1);
//    $node_type->setThirdPartySetting('social_simple', 'networks', $networks);
//    $node_type->setThirdPartySetting('social_simple', 'title', 'Share on');
//    $node_type->save();
...
//      'linkedin' => 'linkedin',
//    ];
//    $node_type->setThirdPartySetting('social_simple', 'hashtags', 'field_tags');
//    $node_type->setThirdPartySetting('social_simple', 'networks', $networks);
//    $node_type->save();
