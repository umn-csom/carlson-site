...
(function (Drupal, myHighcharts) {
  Drupal.behaviors.highchartsStatDonut = {
    attach: function () {
      ...
      if (document.getElementById("highcharts-stat-donut-small")){
        myHighcharts.push({
      ...
      if (document.getElementById("highcharts-stat-donut-medium")){
        myHighcharts.push({
      ...
      if (document.getElementById("highcharts-stat-donut-large")){
        myHighcharts.push({
